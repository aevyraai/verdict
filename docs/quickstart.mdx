...
If you have [Ollama](https://ollama.com) running locally, you can benchmark against it
...
<CardGroup cols={2}>
  <Card title="Compare more models" icon="layer-group" href="/verdict/providers">
    Use a config file to manage multiple models including local vLLM instances
  </Card>
  <Card title="Add an LLM judge" icon="gavel" href="/verdict/metrics">
