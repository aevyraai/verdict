...
Usage:
  aevyra-verdict run dataset.jsonl -m openai/gpt-4o --custom-metric custom_metrics.py:brevity_score
  aevyra-verdict run dataset.jsonl -m openai/gpt-4o --custom-metric custom_metrics.py:contains_code
"""
