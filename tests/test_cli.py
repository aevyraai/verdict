...
class TestConfigFileParsing:
    ...
    def test_json_config_parsed(self, tmp_path):
        ...
        config.write_text(json.dumps({"models": [{"provider": "openai", "model": "gpt-5.4-nano"}]}))
...
class TestRunFlags:
    ...
    def test_custom_metric_flag(self, tmp_path):
        ...
        metric_file.write_text("def my_score(response, ideal=None, **kwargs):\n    return 1.0\n")
        result = runner.invoke(
            app,
            [
                "run",
